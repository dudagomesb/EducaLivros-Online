...
CREATE TABLE Coordenador (
    ...
    FOREIGN KEY (fk_Professor_fk_Usuario_ID_Usuario) REFERENCES Professor(fk_Usuario_ID_Usuario)
);

CREATE TABLE Escreve (
    fk_Livro_ID_Livro INT,
    fk_Autor_Nome VARCHAR,
    PRIMARY KEY (fk_Livro_ID_Livro, fk_Autor_Nome),
    FOREIGN KEY (fk_Livro_ID_Livro) REFERENCES Livro(ID_Livro),
    FOREIGN KEY (fk_Autor_Nome) REFERENCES Autor(Nome)
);

CREATE TABLE Efetua_Consulta (
    fk_Usuario_ID_Usuario INT,
    fk_Emprestimo_ID_Emprestimo INT,
    PRIMARY KEY (fk_Usuario_ID_Usuario, fk_Emprestimo_ID_Emprestimo),
    FOREIGN KEY (fk_Usuario_ID_Usuario) REFERENCES Usuario(ID_Usuario),
    FOREIGN KEY (fk_Emprestimo_ID_Emprestimo) REFERENCES Emprestimo(ID_Emprestimo)
);
...
CREATE TABLE Auxilia (
    ...
    PRIMARY KEY (fk_Presencial_Biblioteca_fk_Emprestimo_ID_Emprestimo, fk_Bibliotecario_ID_Funcao_Biblioteca),
    FOREIGN KEY (fk_Presencial_Biblioteca_fk_Emprestimo_ID_Emprestimo) REFERENCES Presencial_Biblioteca(fk_Emprestimo_ID_Emprestimo),
    FOREIGN KEY (fk_Bibliotecario_ID_Funcao_Biblioteca) REFERENCES Bibliotecario(ID_Funcao_Biblioteca)
);
...
CREATE TABLE Ministra (
    ...
    PRIMARY KEY (fk_Professor_fk_Usuario_ID_Usuario, fk_Disciplina_Codigo, fk_Avaliacao_Id_Aluno),
    FOREIGN KEY (fk_Professor_fk_Usuario_ID_Usuario) REFERENCES Professor(fk_Usuario_ID_Usuario),
    FOREIGN KEY (fk_Disciplina_Codigo) REFERENCES Disciplina(Codigo),
...
CREATE TABLE Estuda (
    ...
    fk_Disciplina_Codigo INT,
    PRIMARY KEY (fk_Aluno_Matricula_fk_Usuario_ID_Usuario, fk_Disciplina_Codigo),
    FOREIGN KEY (fk_Aluno_Matricula_fk_Usuario_ID_Usuario, fk_Disciplina_Codigo) REFERENCES Aluno_Matricula(fk_Usuario_ID_Usuario, Numero)
);

CREATE TABLE Assiste (
    fk_Aluno_Matricula_fk_Usuario_ID_Usuario INT,
    fk_Aula_Codigo_Turma INT,
    PRIMARY KEY (fk_Aluno_Matricula_fk_Usuario_ID_Usuario, fk_Aula_Codigo_Turma),
    FOREIGN KEY (fk_Aluno_Matricula_fk_Usuario_ID_Usuario, fk_Aula_Codigo_Turma) REFERENCES Aluno_Matricula(fk_Usuario_ID_Usuario, Numero)
);
